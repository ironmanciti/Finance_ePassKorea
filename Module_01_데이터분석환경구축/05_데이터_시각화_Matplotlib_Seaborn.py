...
# %% colab={"base_uri": "https://localhost:8080/", "height": 633} id="O-iZzkJ9jMF0" outputId="438b257a-e28a-4b45-e41a-96f7b83f519c"
import pandas as pd
import numpy as np
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 297} id="1DiOjS59jMF1" outputId="0bd51384-5cbc-4c82-ba37-bc990ae33038"
import numpy as np
import pandas as pd
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 525} id="Eqwbm5KYjMF2" outputId="f74d31cd-0567-41c3-9fad-b3c5ac317f6a"
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 525} id="V0za1951jMF2" outputId="a18174a8-e842-45bc-f18a-c43e602674d0"
# 실습 2-2: 스타일 적용 선 그래프
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 625} id="eSf-iVjzjMF2" outputId="b01a3596-c878-4b00-cfae-80e9806b20f4"
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 525} id="1SduZ7jjjMF3" outputId="05c3dc03-e7a0-40d4-8ef2-fdf7974284c8"
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 544} id="eQzx3IBSjMF3" outputId="b3c9cb89-afcc-48ae-c039-d2638e0a8036"
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 525} id="B-z22xPfjMF3" outputId="06eb679e-c6fd-4c96-b186-bd4548963b5e"
# 실습 4-1: 종가 분포 히스토그램
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 525} id="RLR3qEryjMF4" outputId="f4bef8d2-0110-4557-ac33-e54ba5de4207"
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 544} id="dRb4Os8vjMF4" outputId="f296a83c-245d-4fcc-89fc-fe78ce8ace32"
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 525} id="ztDuakJZjMF4" outputId="53167537-501d-421d-cfc9-dd8441b9d68f"
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 617} id="wEUh8OomjMF4" outputId="71dac131-5596-4a9d-dd7b-c1aae50e197c"
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 598} id="TgOjLQMpjMF5" outputId="df6ba85b-fa13-4ac5-f7d2-0efd862a1330"

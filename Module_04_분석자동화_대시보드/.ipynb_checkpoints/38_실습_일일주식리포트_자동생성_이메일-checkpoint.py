...
#
# 실행 방법:
#     python 38_실습_일일주식리포트_자동생성_이메일.py
...
#     
#     bar_colors = ['red' if c >= 0 else 'blue' for c in changes]
#     
#     bars = ax.bar(indices, values, color=bar_colors, alpha=0.7)
#     
#     # 등락률 표시
...
# #    - .env 파일로 보안 관리
# #
# # 다음 차시: 39-40차시 - 투자 분석 자동화 시스템 프로젝트

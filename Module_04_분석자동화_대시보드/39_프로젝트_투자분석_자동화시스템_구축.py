...
# %%
# # !pip install -Uq pykrx pandas-datareader reportlab openpyxl python-dotenv openai beautifulsoup4 requests
...
class Analyzer:
    ...
    def calculate_rsi(self, df: pd.DataFrame, price_col: str = '종가', period: int = 14) -> pd.DataFrame:
        """
    ...
    def calculate_macd(self, df: pd.DataFrame, price_col: str = '종가', 
...
if __name__ == "__main__":
    ...
    result = run_investment_analysis_pipeline(
        ...
        send_email_flag=False  # 이메일 발송은 .env 설정 후 True로 변경
    )
